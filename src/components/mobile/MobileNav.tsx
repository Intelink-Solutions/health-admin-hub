  ...
  return (
    <div className="md:hidden">
      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        <SheetContent
          side="left"
          className="w-[86%] max-w-xs p-0 bg-white dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:slide-in-from-left data-[state=closed]:slide-out-to-left data-[state=open]:duration-300 data-[state=closed]:duration-200"
        >
          <SheetHeader className="relative border-b border-slate-200 dark:border-slate-800 p-4 pb-3 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between w-full">
              ...
              {/* Footer Info */}
              <div className="absolute bottom-4 left-4 right-4 text-center text-xs text-slate-500 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800 pt-4">
                <p>BesaPlus v1.0.0</p>
